...
java -Djava.library.path="/usr/lib/jni/" -jar store/SX4.jar -s ttyUSB0 -t FCC -d

# SLX825 an USB0, debugging on
#java -Djava.library.path="/usr/lib/jni/" -jar store/SX4.jar -s ttyUSB0 -t SLX825 -b 9600 -d 
